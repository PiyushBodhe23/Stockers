...
function brokerage() {
    return (
        <div class='container'>
            ...
            <div class="col-6">
            <h2 class="pt-5" style={{fontSize:"25px"}}>
                Securities/Commodities transaction tax
            </h2>

            <p class='text-muted'>Tax by the government when transacting on the exchanges. Charged as above on both buy and sell sides when trading equity delivery. Charged only on selling side when trading intraday or on F&O.
            </p>

            <p>When trading at Stockers, STT/CTT can be a lot more than the brokerage we charge. Important to keep a tab.
            </p>

            <h2 style={{fontSize:"25px"}}>Transaction/Turnover Charges</h2>
            ...
            <h2 style={{fontSize:"25px"}}>Call & trade</h2>

            <p>Additional charges of ₹50 per order for orders placed through a dealer at Stockers including auto square off orders.</p>

            <h2 style={{fontSize:"25px"}}>Stamp charges</h2>
            ...
            <h2 style={{fontSize:"25px"}}>NRI brokerage charges</h2>

            <p>For a non-PIS account, 0.5% or ₹50 per executed order for equity and F&O (whichever is lower).<br/>
            For a PIS account, 0.5% or ₹200 per executed order for equity (whichever is lower).<br/>
            ₹500 + GST as yearly account maintenance charges (AMC) charges.
            </p>
            
            <h2 style={{fontSize:"25px"}}>Account with debit balance</h2>
            ...
            <h2 style={{fontSize:"25px"}}>Charges for Investor's Protection Fund Trust (IPFT) by NSE</h2>

            <p>Equity and Futures - ₹10 per crore + GST of the traded value.<br/>
            Options - ₹50 per crore + GST traded value (premium value).<br/>
            Currency - ₹0.05 per lakh + GST of turnover for Futures and ₹2 per lakh + GST of premium for Options.<br/>
            </p>
            <h2 style={{fontSize:"25px"}}>
               Margin Trading Facility (MTF)
            </h2>

            <p>MTF Interest: 0.04% per day (₹40 per lakh) on the funded amount. The interest is applied from T+1 day until the day MTF stocks are sold.<br/>
            MTF Brokerage: 0.3% or Rs. 20/executed order, whichever is lower.<br/>
            MTF pledge charge: ₹15 + GST per pledge and unpledge request per ISIN.
            </p>

            </div>
             <div class="col-6 pl-5">
            <h2 class="pt-5" style={{fontSize:"25px"}}>GST</h2>

            <p>Tax levied by the government on the services rendered. 18% of ( brokerage + SEBI charges + transaction charges)</p>

            <h2 style={{fontSize:"25px"}}>SEBI Charges</h2>

            <p>Charged at ₹10 per crore + GST by Securities and Exchange Board of India for regulating the markets.</p>

            <h2 style={{fontSize:"25px"}}>DP (Depository participant) charges</h2>

            <p>₹15.34 per scrip (₹3.5 CDSL fee + ₹9.5 Stockers fee + ₹2.34 GST) is charged on the trading account ledger when stocks are sold, irrespective of quantity.</p>
            ...
            <h2 style={{fontSize:"25px"}}>Pledging charges</h2>

            <p>₹30 + GST per pledge request per ISIN.</p>

            <h2 style={{fontSize:"25px"}}>AMC (Account maintenance charges)</h2>
            ...
            <h2 style={{fontSize:"25px"}}>Corporate action order charges</h2>

            <p>₹20 plus GST will be charged for OFS / buyback / takeover / delisting orders placed through Console.</p>

            <h2 style={{fontSize:"25px"}}>Off-market transfer charges</h2>

            <p>₹25 per transaction.</p>

            <h2 style={{fontSize:"25px"}}>Physical CMR request</h2>

            <p>First CMR request is free. ₹20 + ₹100 (courier charge) + 18% GST for subsequent requests.</p>

            <h2 style={{fontSize:"25px"}}>Payment gateway charges</h2>

            <p>₹9 + GST (Not levied on transfers done via UPI)</p>

            <h2 style={{fontSize:"25px"}}>Delayed Payment Charges</h2>

            <p>Interest is levied at 18% a year or 0.05% per day on the debit balance in your trading account. Learn more.</p>

            <h2 style={{fontSize:"25px"}}>Trading using 3-in-1 account with block functionality</h2>

            <p>Delivery & MTF Brokerage: 0.5% per executed order.<br/>
            Intraday Brokerage: 0.05% per executed order.
            </p>
            </div>
</div>
            <h2 style={{fontSize:"25px", paddingTop:"25px"}}>Disclaimer</h2>
